<%-- 
    Document   : CustomerViewReservations
    Created on : Feb 16, 2017, 8:43:05 PM
    Author     : Nota
    Author     : Jamie
--%>
              ...
              <div class="row">
                  <%
                        ...
                        for(int i = 0; i < length;i++){
                            ...
                            String name = reservation.getRestaurantName();
                            String restaurantEmail = reservation.getRestaurantEmail();
                  ...
                  <div class="col-sm-4">
                      ...
                      <p>Restaurant email:<%=restaurantEmail%></p>
